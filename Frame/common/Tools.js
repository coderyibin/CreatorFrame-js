...
var Tools = {
    ...
    */
     ...
     * @return {Vec2}
     * @example
     * cc.pNeg(cc.v2(10, 10));// Vec2 {x: -10, y: -10};//这是cocos引擎的算法
     * Tools.GetNeg(cc.v2(10, 10));// Vec2 {x: -10, y: -10};
     */
    GetNeg (point) {
    ...
    }, GetAdd (v1, v2) { return this.AddPoint(v1, v2)},
    ...
    GetDistanceSQ (point1, point2) {
        return cc.pDistanceSQ(point1, point2)
    },
    ...
    // };
    GetClampf (value, min_inclusive, max_inclusive) {
        return cc.clampf(value, min_inclusive, max_inclusive)
    },
    ...
    // };
    GetClamp (p, min_inclusive, max_inclusive) {
        return cc.pClamp(p, min_inclusive, max_inclusive)
    },
    ...
    //     return false;
    // };
    GetFuzzyEqual (a, b, variance) {
        return cc.pFuzzyEqual(a, b, variance)
    },
    ...
    //     return r;
    // };
    GetRotateByAngle (v, pivot, angle) {
        return cc.pRotateByAngle(v, pivot, angle)
    },
    ...
    //     return true;
    // };
    GetLineIntersect (A, B, C, D, retP) {
        return cc.pLineIntersect(A, B, C, D, retP)
    },
    ...
    GetIntersectPoint (A, B, C, D) {
        return cc.pIntersectPoint(A, B, C, D)
    },
    ...
    //     point.y *= floatVar;
    // };
    GetMultIn (point, floatVar) {
        cc.pMultIn(point, floatVar)
    },
     ...
     * @method GetPointToWorld
     * @param {Vec2} nodePoint
     * @return {Vec2}
     * @example
     * var newVec2 = node.convertToWorldSpace(cc.v2(100, 100));
     * Tools.GetPointToWorldPosition(node, cc.v2(100, 100))
     */
    GetPointToWorld (node, nodePoint) {
        return node.convertToWorldSpace(nodePoint)
    },
     ...
     */
    GetPointToNode (node, worldPoint) {
